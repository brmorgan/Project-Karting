...
//================================= Bounds Functions =================================================
	...
	public static void SetCameraBounds(Camera cam=null)
	{
		...
		// Make Vector3's at the topLeft and bottomRight of the Screen coords
		...
		// Adjust their z's ot be at the near and far Camera clipping planes
	...
	// Checks to see whether the Bounds bnd are within the camBounsd
	public static Vector3 ScreenBoundsCheck(Bounds bnd, BoundsTest test = BoundsTest.center)
	{
		return (BoundsInBoundsCheck (camBounds, bnd, test));
	}

	// Checks to see whether Bounds lilB are within BoundsbigB
...
//================================= Transform Functions ===============================================
	...
	// until it either finds a paretn with a tag != "Untagged" or no parent
	public static GameObject FindTaggedParent(GameObject go)
	{
		...
		if (go.GetComponent<Transform>().parent == null) {
			// We've reached the top of the hierarchy with no interesting tag
			// So return null
			return (null);
		}
		// Otherwise, recursively climb up the tree
		return(FindTaggedParent (go.GetComponent<Transform>().parent.gameObject));
	}
